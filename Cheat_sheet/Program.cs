...
характерная особенность ранних операционных систем
 (например, MS DOS), использующих интерфейс командной строки 
 для интерактивного обмена информацией с пользователем. 
WriteLine
*/
...
string username = Console.ReadLine();    
             // метод для ввода строки символов типа стринг. 
             //Дословно берем переменную userename и присваиваем ее символам 
             //строковый тип == текст
*/

/* команда присваивания случайного числав диапазоне
...
if(username.ToLower() == "маша")          
             // если переменная типа стока имеет значение маша 
...
/*
Console.Clear();                                  
             //метод очищения консоли. Удаляет из буфера консоли  
             //и ее окна отображаемую информацию.
Console.SetCursorPosition(10, 4);             
             //метод, указывает, где начинается следующая операция записи в окне консоли.
Console.WriteLine("+");                        
              //при выводе сообщения будет прописываться символ +
